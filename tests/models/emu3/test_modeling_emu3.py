...
class Emu3ModelTester:
    ...
    def prepare_config_and_inputs(self):
        ...
        # pixel_embeddings = floats_numpy([self.batch_size, self.base_channels, self.image_size//self.image_factor, self.image_size//self.image_factor])
...
EMU3_CASES = [
    [
        "Emu3ForCausalLM",
        "transformers.Emu3ForCausalLM",
        "mindway.transformers.Emu3ForCausalLM",
        (text_config,),
        {},
        (),
